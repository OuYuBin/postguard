 ...
 * </p>
 * <ul>
 *   <li>{@link com.gesila.test.guard.model.testGuard.impl.RequestBodyImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequestBodyImpl extends MinimalEObjectImpl.Container implements RequestBody {
	...
	protected EClass eStaticClass() {
		return TestGuardPackage.Literals.REQUEST_BODY;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestGuardPackage.REQUEST_BODY__VALUE, oldValue, value));
	}
