 ...
 * </p>
 * <ul>
 *   <li>{@link com.gesila.test.guard.model.testGuard.impl.TestGuardModuleImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link com.gesila.test.guard.model.testGuard.impl.TestGuardModuleImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TestGuardModuleImpl extends MinimalEObjectImpl.Container implements TestGuardModule {
	/**
	 ...
	 * @ordered
	 */
	protected EList<TestGuardUnit> unit;
	...
	protected EClass eStaticClass() {
		return TestGuardPackage.Literals.TEST_GUARD_MODULE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestGuardPackage.TEST_GUARD_MODULE__NAME, oldName, name));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case TestGuardPackage.TEST_GUARD_MODULE__UNIT:
				getUnit().clear();
				getUnit().addAll((Collection<? extends TestGuardUnit>)newValue);
				return;
			case TestGuardPackage.TEST_GUARD_MODULE__NAME:
