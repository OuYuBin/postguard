 ...
 *
 */
public class PostGuardCopyAction extends SelectionListenerAction {
     ...
     */
    public PostGuardCopyAction(Shell shell, Clipboard clipboard) {
     ...
     * @since 2.0
     */
    public PostGuardCopyAction(Shell shell, Clipboard clipboard, PostGuardPasteAction pasteAction) {
