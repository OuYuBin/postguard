...
/**
 * This is the item provider adapter for a {@link com.gesila.test.guard.model.testGuard.Params} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParamsItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TestGuardPackage.Literals.PARAMS__PARAM);
		}
	...
	public Object getStyledText(Object object) {
		return new StyledString(getString("_UI_Params_type"));
	}	
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Params.class)) {
			case TestGuardPackage.PARAMS__PARAM:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TestGuardPackage.Literals.PARAMS__PARAM,
				 TestGuardFactory.eINSTANCE.createParam()));
	}
