...
/**
 * This is the item provider adapter for a {@link com.keliangtek.simulab.target.Name} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NameItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Name_Content_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Name_Content_feature", "_UI_Name_type"),
				 TargetPackage.Literals.NAME__CONTENT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Name)object).getContent();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Name.class)) {
			case TargetPackage.NAME__CONTENT:
